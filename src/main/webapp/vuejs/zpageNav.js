...
*
*
*       <vue-pagination v-bind:page="pageNum" v-bind:page-size="pageSize" v-bind:total="total"
                  v-bind:max-page="maxPage"  v-on:pagehandler="pageHandler">
        </vue-pagination>


*    pageHandler:function(pageNum){ //这个相当于是zpageNav.js分页插件里的change方法
            let _this=this;
            _this.pageNum=pageNum;
            axios.post('../user/findPage.do?pageNum='+_this.pageNum+"&pageSize="+_this.pageSize).then(
                function (response) {
